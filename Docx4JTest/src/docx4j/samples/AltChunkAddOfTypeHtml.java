...
public class AltChunkAddOfTypeHtml {
	...
	public static void main(String[] args) throws Exception {
		...
		String html = "<html><head><title>Import me</title></head><body><h1>Hello World!</h1></body></html>"; 

		wordMLPackage.getMainDocumentPart().addAltChunk(AltChunkType.Html, html.getBytes()); 

		wordMLPackage.save(new java.io.File(System.getProperty("user.dir") + "/src/test.docx"));		
	}
