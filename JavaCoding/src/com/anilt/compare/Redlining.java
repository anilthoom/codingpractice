...
//import com.anil.practise.compare.Redlining.Diff;
...
public class Redlining {
  ...
  /**
   * The key structure representing a diff is a Linked list of Diff objects:
  ...
  private LinkedList<Diff> diff_compute(String text1, String text2,
    ...
    if (hm != null) {
      // A half-match was found, sort out the return key.
      String text1_a = hm[0];
      String text1_b = hm[1];
      String text2_a = hm[2];
      String text2_b = hm[3];
   ...
   * @return LinkedListTest of Diff objects.
   */
   ...
   * text.
   * @param diffs LinkedListTest of Diff objects.
   * @param lineArray List of unique strings.
   */
   ...
   * @return LinkedListTest of Patch objects.
   */
   ...
   * @param diffs Array of Diff objects for text1 to text2.
   * @return LinkedListTest of Patch objects.
   * @deprecated Prefer patch_make(String text1, LinkedListTest<Diff> diffs).
   */
  public LinkedList<Patch> patch_make(String text1, String text2,
      LinkedList<Diff> diffs) {
    return patch_make(text1, diffs);
   ...
   * Intended to be called only from within patch_apply.
   * @param patches LinkedListTest of Patch objects.
   */
  ...
  {
	String clauseVersion1 = "abcd";
	String clauseVersion2 = "dcba";
	Redlining r = new Redlining();
	LinkedList<Diff> lDiff = r.diff_main(clauseVersion1, clauseVersion2);
